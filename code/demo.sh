...
cp "file.txt" "threeClusters.csv" "$tmp_dir1/"
cp "file.txt" "threeClusters.csv" "$tmp_dir2/"
cp "file.txt" "threeClusters.csv" "$tmp_dir3/"
cp "file.txt" "threeClusters.csv" "$tmp_dir4/"
