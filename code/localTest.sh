...
sleep 5;
cd "$tmp_dir2" || exit; java Client -testing -host -file "$tmp_dir2/file1.txt" &
cd "$tmp_dir3" || exit; java Client -testing -file "$tmp_dir3/file2.txt" &
cd "$tmp_dir4" || exit; java Client -testing -file "$tmp_dir4/file3.txt"
